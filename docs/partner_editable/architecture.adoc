...
** An Amazon Elastic Compute Cloud (Amazon EC2) instance in an Auto Scaling group to ensure continuous availability.

* Classic Load Balancer to route data traffic to {partner-product-name} over HTTP.
