...
* *SiteWiseAsset*: The name of the asset created for receiving the UA tag data from the edgeConnector UA endpoint.
...
* *edgeConnectorSiemens*: The URL to the local administration/configuration interface of the edgeConnector.

=== In {partner-product-short-name}

NOTE: If the simulated connection that is preconfigured with {partner-product-short-name} fails, but you still need to verify or recreate a connection, you can perform the following steps. 
